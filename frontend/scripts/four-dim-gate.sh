...
# Positioning 2026-08: category is "route layer / action layer for web
# agents" — NOT "API-native browser" (Better Trap). Canon:
# docs/public/POSITIONING.md. Numbers, install, and github remain
# load-bearing.
REQUIRED = [
    "route layer for web agents",
    "3.6x",
    "5.4x",
    "npx unbrowse setup",
...
FORBIDDEN = [
    ...
    "API-native browser",  # banned category claim
    "API native browser",
]
