#!/bin/bash
# verify.sh - runs the declared verify_gate for plan "test-unbrowse-npm-install-setup-mcp-wire-first-r".
...
cd "$(dirname "$0")/../../.."
export PLAN=test-unbrowse-npm-install-setup-mcp-wire-first-r
