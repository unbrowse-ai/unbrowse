...
export function HeroSubhead() {
  ...
  return (
    <p className="animate-fade-up stagger-2 mt-5 sm:mt-6 text-base sm:text-xl text-text-secondary max-w-2xl leading-relaxed">
      First-party routes first. Browser only when the site still requires
      it.
    </p>
  );
}
 ...
 *   Current (positioning 2026-08): "The route layer for web agents."
 *   Avoids the Better Trap of competing as a "better browser" (wrong shelf).
 *   Canon: docs/public/POSITIONING.md
 *
...
export function HeroHeadlineInner() {
  return (
    <>
      The{" "}
      <span className="text-orange-500">route layer for web agents.</span>
    </>
  );
}
