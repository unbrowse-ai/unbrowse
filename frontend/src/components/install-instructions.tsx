...
const TABS = [
  {
    id: "claude-code",
    label: "CLAUDE CODE",
    copyText: "claude mcp add unbrowse -- npx -y unbrowse mcp",
    lines: [
  ...
  },
  {
    ...
    lines: [
      ...
      { type: "cmd",     text: "  $  npx unbrowse setup --mcp" },
      { type: "blank",   text: "" },
      { type: "comment", text: "  ##  generic stdio command, for hosts without auto-wiring" },
      { type: "cmd",     text: "  $  npx -y unbrowse mcp" },
      { type: "blank",   text: "" },
