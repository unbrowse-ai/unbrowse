...
const TABS = [
  {
    ...
    lines: [
      ...
      { type: "divider", text: "──────────────────────────────────────────────" },
      { type: "comment", text: "  ##  install the binary" },
      { type: "cmd",     text: "  $  npm install -g unbrowse" },
      { type: "blank",   text: "" },
      { type: "comment", text: "  ##  install the Agent Skill + browser engine" },
  ...
  },
  {
    ...
    lines: [
      ...
      { type: "cmd",     text: "  $  unbrowse setup" },
      { type: "blank",   text: "" },
      { type: "comment", text: "  ##  skill-aware hosts read ~/.claude/skills/unbrowse/SKILL.md" },
    ] as TLine[],
  },
  {
    id: "codex",
