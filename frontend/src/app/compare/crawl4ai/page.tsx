...
const c = competitors.crawl4ai;

export const metadata: Metadata = {
  title: `${c.tagline} — Crawl4AI Alternative for AI Agents | Unbrowse`,
...
export default function Crawl4AICompare() {
  return <ComparisonPage slug="crawl4ai" />;
}
