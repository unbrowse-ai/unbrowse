/* /aiko/chat — Aiko, the grounded assistant (relocated from /aiko so the
 * top-level /aiko route can host the product landing). Backed by the Aiko
 * endpoint (OpenAI-compatible) which grounds every external fact through
 * unbrowse's route graph (free, keyless DDG) and answers from what it finds,
 * showing the unbrowse source under each answer. */
