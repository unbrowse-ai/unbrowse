...
export default function SecurityPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 pt-28 pb-20">
        ...
        <div className="border border-border rounded-md p-5 bg-surface-raised">
          ...
          <ul className="mt-4 space-y-2 text-sm text-text-secondary leading-relaxed">
            ...
            <li>
              ...
              wallet-signed cryptographic proof — math that confirms you hold the
              credential without revealing it. The site sees a valid sign-in; nobody
              sees your secret.
            </li>
          </ul>
      ...
      <PapersBehind theme="privacy" intro="The architecture behind this — one Ed25519 wallet key signing every layer, credentials bound as one-way wallet-signed commitments and revealed only under signature — is laid out in the security paper." />
    </div>
  );
}
