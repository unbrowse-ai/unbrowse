...
const ONE_LINER =
  "Unbrowse is the route layer for web agents: it learns first-party API routes from real browsing, reuses them on later calls, and keeps a browser only when the site still requires it.";

const SHORT_DESCRIPTION =
  "Unbrowse is an open-source action layer for AI agents. The first visit can capture the first-party routes a page already calls; later calls reuse those routes when valid and return structured data instead of re-driving a browser. Browser automation remains the honest fallback for misses, auth, and pure UI.";
