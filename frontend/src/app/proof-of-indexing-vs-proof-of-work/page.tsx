...
const sections: { title: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Proof of indexing is the coordination mechanism for this layer. It is to the route graph what proof of work is to the blockchain: the engine that converts individual incentives into collective infrastructure. The arXiv paper (arxiv.org/abs/2604.00694) formalizes the technical architecture. The x402 protocol handles the payment rail. USDC on Solana and Base provides the settlement layer. The 70/30 contributor split provides the incentive alignment.",
