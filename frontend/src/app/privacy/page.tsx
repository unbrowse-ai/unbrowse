    ...
    <div className="max-w-3xl mx-auto px-6 pt-28 pb-20">
      ...
      <div className="space-y-12 animate-fade-up stagger-2">
        ...
        <Section title="What never leaves your machine">
          ...
          <p>
            This works through a <strong>wallet-signed cryptographic proof</strong>: Unbrowse can verify that you
      ...
      <div className="mt-16">
        <PapersBehind theme="privacy" intro="How this works cryptographically — credentials bound to your wallet as one-way signed commitments, revealed only under your signature — is in the security paper." />
      </div>
