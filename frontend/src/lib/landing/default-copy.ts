...
export const DEFAULT_HOME_COPY = {
  ...
  installSummary:
    "Local runtime first. Then pick the tab for your actual host: CLI, MCP, Claude Code, Cursor, or OpenClaw. Bee mode: npm i -g @unbrowse/pollen-cli (pollen · forage · buzz · swarm).",
};
