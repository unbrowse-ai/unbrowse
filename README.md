...
> **Note:** The previous OpenClaw plugin has been deprecated. This repo is now the universal Unbrowse skill — it works with any agent (Claude Code, Cursor, Codex, Windsurf, etc.), not just OpenClaw.
