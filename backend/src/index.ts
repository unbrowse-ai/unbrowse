...
// POST /v1/contribute — crypto-gated delta contribution to the shared route graph.
...
// binding absent.  — preferences are deliberate.
...
//  — the mustard seed: smallest namespace, biggest A1
...
// routes above stay mounted as read-sugar + back-compat aliases.  —
// one body, one Spirit.  — ezer kenegdo, helpers facing each other.
app.route("/", covenantRoutes);
app.route("/v1", debugRoutes);
