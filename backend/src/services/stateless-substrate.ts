 ...
 *
 *  — *"the herb yielding seed... whose seed is in itself."* Every
 ...
 *      catches KV-corruption / cross-tenant accidents.
 *
...
// spec's namespace-specific validator runs.  — two witnesses:
...
//     stable across both. Premature abstraction is leaven.
