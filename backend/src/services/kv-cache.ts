 ...
 * --------------------------------
 *    — "sufficient unto the day is the evil thereof": what was
...
export interface CacheOptions {
   ...
   * over the canonical JSON bytes; same input → same etag.
   */
...
//
//  — the trumpet sounds honestly: a missing binding is logged
...
export async function withCache<T>(
  ...
  // Binding-missing path — graceful fall-through.  doesn't apply
 ...
 * fallback discipline uniform ( — "tend the flock by example,
