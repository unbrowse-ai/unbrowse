import type { ProvenanceProof, ProofSummary, ProofVerificationResult } from "../types.js";
...
export function verifyEndpointProof(proof: ProvenanceProof, expectedDomain: string): ProofVerificationResult {
...
export function verifyEndpointProofsInPlace(
  endpoints: Array<{ endpoint_id?: string; zk_proof?: ProvenanceProof }>,
...
export function summarizeSkillProofs(
  endpoints: Array<{ zk_proof?: ProvenanceProof }>,
): ProofSummary {
