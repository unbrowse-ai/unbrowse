#!/bin/bash
# verify.sh - runs the declared verify_gate for plan "add-a-flash-minimal-resolve-output-mode-to-unbro".
...
cd "$(dirname "$0")/../../.."
export PLAN=add-a-flash-minimal-resolve-output-mode-to-unbro
