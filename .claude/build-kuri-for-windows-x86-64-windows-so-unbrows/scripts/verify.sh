#!/bin/bash
# verify.sh - runs the declared verify_gate for plan "build-kuri-for-windows-x86-64-windows-so-unbrows".
...
cd "$(dirname "$0")/../../.."
export PLAN=build-kuri-for-windows-x86-64-windows-so-unbrows
