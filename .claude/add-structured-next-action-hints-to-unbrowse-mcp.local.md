...
bound_contracts:
  ...
  # - minimize-the-unbrowse-cli-and-mcp-flag-surface-p   # organ-mate candidate, overlap 0.224
  # - rebuild-the-unbrowse-sdk-as-a-thin-http-first-ty   # organ-mate candidate, overlap 0.224
  # - add-an-opt-in-paid-residential-proxy-fallback-fo   # organ-mate candidate, overlap 0.207
  # - audit-the-unbrowse-capture-enrichment-resolve-ra   # organ-mate candidate, overlap 0.207
  # - make-unbrowse-banger-a-meta-contract-that-writes   # organ-mate candidate, overlap 0.207
  #
  ...
  #   ~ unbrowse-self-build   overlap 0.207
  #   ~ unbrowse-improvement-loop   overlap 0.19
  #   ~ unbrowse-improvement-fleet   overlap 0.138
  #   ~ aiko-v3-improvement-loop   overlap 0.121
...
```
.claude/add-structured-next-action-hints-to-unbrowse-mcp/
├── scripts/
...
```bash
bash .claude/add-structured-next-action-hints-to-unbrowse-mcp/scripts/iterate.sh
```
