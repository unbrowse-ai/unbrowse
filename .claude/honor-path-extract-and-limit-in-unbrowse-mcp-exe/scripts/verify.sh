#!/bin/bash
# verify.sh - runs the declared verify_gate for plan "honor-path-extract-and-limit-in-unbrowse-mcp-exe".
...
cd "$(dirname "$0")/../../.."
export PLAN=honor-path-extract-and-limit-in-unbrowse-mcp-exe
