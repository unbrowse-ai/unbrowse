...
bound_contracts:
  ...
  # - add-structured-next-action-hints-to-unbrowse-mcp   # organ-mate candidate, overlap 0.439
  # - honor-path-extract-and-limit-in-unbrowse-mcp-exe   # organ-mate candidate, overlap 0.281
  # - build-end-to-end-funnel-tracking-for-unbrowse-ev   # organ-mate candidate, overlap 0.263
  # - audit-the-unbrowse-capture-enrichment-resolve-ra   # organ-mate candidate, overlap 0.246
  # - drive-every-bug-class-surfaced-by-the-mcp-gate-r   # organ-mate candidate, overlap 0.246
  #
  ...
  #   ~ unbrowse-self-build   overlap 0.175
  #   ~ autonomous-build-harness   overlap 0.158
  #   ~ unbrowse-improvement-loop   overlap 0.158
  #   ~ aiko-v3-improvement-loop   overlap 0.14
...
```
.claude/add-a-flash-minimal-resolve-output-mode-to-unbro/
├── scripts/
...
```bash
bash .claude/add-a-flash-minimal-resolve-output-mode-to-unbro/scripts/iterate.sh
```
