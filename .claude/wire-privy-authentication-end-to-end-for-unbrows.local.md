...
```
.claude/wire-privy-authentication-end-to-end-for-unbrows/
├── scripts/
...
```bash
bash .claude/wire-privy-authentication-end-to-end-for-unbrows/scripts/iterate.sh
```
