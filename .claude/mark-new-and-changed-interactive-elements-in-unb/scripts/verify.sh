#!/bin/bash
# verify.sh - runs the declared verify_gate for plan "mark-new-and-changed-interactive-elements-in-unb".
...
cd "$(dirname "$0")/../../.."
export PLAN=mark-new-and-changed-interactive-elements-in-unb
# scripts/verify.sh -> ../ is the plan scaffold root
export SCAFFOLD="$(cd "$(dirname "$0")/.." && pwd)"
TS=$(date -u +"%Y-%m-%dT%H:%M:%SZ")

echo "[verify:$PLAN] gate: project sniff (package.json:scripts.test)"
