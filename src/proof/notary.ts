...
import type { ProvenanceProof } from "../types/proof.js";
...
export interface NotaryClient {
  ...
  verifyTlsProof(proof: ProvenanceProof): Promise<boolean>;
}
...
export function createNotaryClient(notaryUrl: string): NotaryClient {
  ...
  return {
    ...
    async verifyTlsProof(proof: ProvenanceProof): Promise<boolean> {
