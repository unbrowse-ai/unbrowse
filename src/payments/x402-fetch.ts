 ...
 *
 * Substrate discipline (CLAUDE.md "Ranker philosophy: heuristics OUT"):
 ...
 *
 * The actual signing primitive is NOT in this module: per the substrate
 * discipline rule "Substrate enables, never prescribes", we don't hardcode
