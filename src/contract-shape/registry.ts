 ...
 * the /contract platform. Per contract 1ef6667f (separation of concerns):
 ...
 * is a separate platform that COMPOSES unbrowse along with lobster,
 ...
 * these neuron specs by `name`, and the /contract platform calls into
