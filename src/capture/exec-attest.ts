 ...
 *
 * Honesty boundary (mirrors the binding-gate scope note): a wallet self-signature proves the
...
import { verifyEd25519 } from "../values/cred-binding.js";
