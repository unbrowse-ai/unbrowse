 ...
 * by the user's own data, bound to their wallet" made into one composed, testable
 * flow over the primitives that already shipped (obfuscate, obfuscate-audit,
 * hole-template, sealed-fill, bound-hole). The response surface is provably
...
import { verifyHoleAttested, proveHoles, verifyHoleProofs, type HoleProofs } from "./bound-hole.js";
