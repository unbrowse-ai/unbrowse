 ...
 * wallet-vault is the obfuscation endgame: each credential is SEALED TO THE
 ...
 *
 * "Any key value sealed to their wallet only for them to use." This is the
 * commitment+AEAD layer the credential binding strengthens; it is correct on
 * its own. Reverse-engineering the client
