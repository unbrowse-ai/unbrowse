/**
 * covenant-toll-ledger — the first-discoverer ledger for the 402 booth.
 *
 * `meter()` / `tollNode()` (covenant-seed) split ONE settled request fairly.
 ...
 * reuser pays the shortcut and that original discoverer is paid — Luke 10:7,
