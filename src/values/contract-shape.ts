 ...
 * (leaven — Synapse-kind minimum, ; and a hard per-primitive list violates
 ...
 * the native enrichment consumers (resolve, execute) compute their OWN richer verdict via
...
export interface ContractVerdict {
  ...
  /** "fallback" = pure-shape (this module); "native" = substrate-enriched (resolution-contract) */
