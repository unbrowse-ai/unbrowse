...
export interface ResolutionContractVerdict {
  ...
  /**
   * Which engine produced the evidence, surfaced never-silent: "fallback" is the pure-TS
   * three-shape drill. (The embedded-substrate enrichment organ is withheld from the public
   * tree; the field shape is kept for compatibility.)
   */
