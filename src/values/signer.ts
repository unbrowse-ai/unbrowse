 ...
 *
 * platform: ZK_SCOPE §"v7.0 (sig-shape)". v7.0 ships a plain Ed25519
...
export async function sign(
  ...
  try {
    ...
    //  — nothing hid; the privkey is zeroed before the function
 ...
 * matches the key (created_at is preserved).  — the same yesterday,
 * today, and forever.
 */
