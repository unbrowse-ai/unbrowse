...
import type { CapabilitySource, CapabilityStatus } from "../architecture/bridge-manifest.js";
 ...
 * pointer-not-payload model the route platform already enforces (cli-v7/_stateless.ts), here
