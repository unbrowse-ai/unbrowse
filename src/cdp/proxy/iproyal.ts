// CDP_PRIMITIVES.md §iproyal-proxy-as-act-effect — geo.iproyal.com:12321 builder
//
  ...
  try {
    ...
    if (!st.isFile()) {
      return {
        ...
        path,
        hint: `path exists but is not a regular file. Replace with a 600-perm JSON or KV file (see ~/(internal)).`,
      };
    }
