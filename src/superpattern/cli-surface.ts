 ...
 * route, logic, or secret. "The CLI is a client only exposing what it needs, via wallet-bound commitments."
 *
 ...
 * it — composes with src/capture/sealed-fill.ts + bound-hole.ts). A Surface
...
const SURFACE: Record<string, Omit<Surface, "command">> = {
  ...
  "eval browsers":         { verb: "eval",   interrogative: "who",   holes: [],                   auth: "none"   },
  ...
  "eval research":         { verb: "eval",   interrogative: "what",  holes: ["intent"],           auth: "none"   },
  "eval extract":          { verb: "eval",   interrogative: "what",  holes: ["url"],              auth: "none"   },
  "eval map":              { verb: "eval",   interrogative: "where", holes: ["url"],              auth: "none"   },
  ...
  "eval schema":           { verb: "eval",   interrogative: "what",  holes: ["command"],          auth: "none"   },
  "eval contract":         { verb: "eval",   interrogative: "why",   holes: ["text", "id"],       auth: "wallet" },
};
