...
const SURFACE: Record<string, Omit<Surface, "command">> = {
  ...
  fetch:           { verb: "breath", interrogative: "how",   holes: ["url"],               auth: "none" },
  // where — routing / publication / location (breath routes; build publishes)
  ...
  mode:            { verb: "breath", interrogative: "when",  holes: ["mode"],              auth: "none" },
