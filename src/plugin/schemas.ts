...
export const GOAL_EXECUTE_SCHEMA = {
  type: "object" as const,
  properties: {
    goal: {
      type: "string" as const,
      description: "Task goal in natural language (e.g. 'fetch my latest orders', 'create a post').",
    },
    service: {
      type: "string" as const,
      description: "Skill/service name. If omitted, inferred from installed skills and goal text.",
    },
    executionMode: {
      type: "string" as const,
    ...
    maxSteps: {
      type: "number" as const,
      description: "Max planned endpoint steps to try (default: 4).",
    },
    checkpointId: {
      type: "string" as const,
      description: "Checkpoint identifier for resume. Auto-generated when omitted.",
    },
    resume: {
      type: "boolean" as const,
      description: "Resume from existing checkpointId (default: false).",
    },
    dryRun: {
      type: "boolean" as const,
      description: "Plan only. Do not execute endpoints (default: false).",
    },
    body: {
      type: "string" as const,
      description: "Optional JSON body override for write endpoints.",
    },
    skillsDir: {
      type: "string" as const,
      description: "Skills directory (default: ~/.openclaw/skills).",
