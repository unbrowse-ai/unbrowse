...
export type PrimitiveKind =
	...
	| "route"; // our native covenant route
...
/** HTTP method → covenant verb: read→eval, delete/act→breath, create/commit→build. */
function verbOfMethod(method: string): CovenantVerb {
