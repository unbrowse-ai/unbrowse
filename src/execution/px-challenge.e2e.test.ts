 ...
 *
 * STATE: solvePxAndRetry is a REAL implementation using bundle-replay.
 * Tests use sandbox boundary mocks for runBundleReplay (external Kuri
 * sandbox over HTTP), mirroring the v14 e2e pattern.
 *
