...
// learned API endpoint, the current platform returns a structured
...
// recovery is the platform's own drift verdict; the data is whatever
 ...
 * platform-faithful: structural primitive, no per-domain knowledge.
 */
 ...
 * platform-neutral; callers pass `endpoint.response_schema`.
 */
...
/**
 * platform-faithful shape-overlap gate for drift recovery.
 *
