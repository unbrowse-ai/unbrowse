 ...
 *   - `solveAkamaiAndRetry` — REAL implementation. Bundle extraction → bundle
 *     fetch → `runBundleReplay` → `_abck` cookie verification → cookie merge
 *     → armed retry fetch.
 */
...
// ---------------------------------------------------------------------------
// solveAkamaiAndRetry — REAL: bundle-replay → _abck → armed retry
// ---------------------------------------------------------------------------
