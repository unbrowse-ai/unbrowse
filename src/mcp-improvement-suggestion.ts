...
// Canonical failure codes the platform maps to suggestions. Lifted directly
...
function defaultLedgerPath(): string {
  ...
  return path.join(os.homedir(), "(internal)", "skills", "unbrowse-improvement-loop", "coverage.jsonl");
}
...
function shouldEnrich(response: Record<string, unknown>): boolean {
  ...
  // resolve. the platform uses this signal to surface fix surfaces.
