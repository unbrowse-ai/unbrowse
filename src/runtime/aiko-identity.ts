 ...
 * declares, and telemetry identify as "aiko" when the substrate is present so
...
const CONTRACT_SUBSTRATE_CANDIDATES = [
  join(homedir(), ".claude", "skills", "contract", "scripts", "aiko"),
...
/** True when this install runs inside the aiko substrate (contract binary, aiko engine, or explicit env). */
...
/** Default marketplace agent name — "aiko" when substrate present, else hostname-rand. */
