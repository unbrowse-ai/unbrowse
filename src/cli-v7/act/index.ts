/**
 * `unbrowse act` subcommand router.
 *
...
export const router: VerbRouter = {
  verb: "act",
  help: (opts: OutputOptions) => routeSub({ verb: "act", sub: "", positional: [], flags: { help: true }, wantsHelp: true, wantsJson: opts.json ?? false } as ParsedV7Args, opts, TABLE, "act") as never,
  dispatch: (parsed: ParsedV7Args, opts: OutputOptions) => routeSub(parsed, opts, TABLE, "act"),
};
