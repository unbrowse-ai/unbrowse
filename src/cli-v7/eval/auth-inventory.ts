 ...
 * browser-open path.
 *
 * SECURITY INVARIANTS (load-bearing — contract ee1f5409 platform
 ...
 *
 * A2 invariant: every read crosses the boundary as a sig-keyed receipt.
...
export async function handler(
  ...
  try {
    ...
    // never crosses the boundary. The receipt's cacheKey surfaces in
