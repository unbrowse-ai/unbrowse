 ...
 *
 * Genesis 1:20 — *"let the waters bring forth abundantly the moving creature."*
 * Matt 13:31-32 — the smallest seed that grows.
 *
 ...
 * firmament. The v6 shape carries four FORBIDDEN fields that the backend's
 ...
 *      step name. Empty rows are pointer-shaped honesty (Heb 11:1).
 ...
 * and projects rows across the firmament.
 *
 * Doctrine: 1 Cor 9:22 — "to the v6 trace I became a v6 trace... that I
 * might gain those across the firmament." The projector is the bridge, not
