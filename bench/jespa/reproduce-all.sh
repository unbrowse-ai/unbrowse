...
EBLLM_PY="${EBLLM_PY:-/Users/lekt9/Games/Overwatch/mlx-framegen/.rife-env/bin/python3}"
...
run "route-EBM: energy ranks unbrowse routes (4.6x)"      env EBLLM_PY="$EBLLM_PY" bash $EB/route_ebm_gate.sh
