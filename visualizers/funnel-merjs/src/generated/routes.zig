...
const api_viz_spec = @import("api/viz-spec");
...
pub const routes: []const Route = &.{
    ...
    .{ .path = "/api/viz-spec", .render = api_viz_spec.render, .render_stream = if (@hasDecl(api_viz_spec, "renderStream")) api_viz_spec.renderStream else null, .meta = if (@hasDecl(api_viz_spec, "meta")) api_viz_spec.meta else .{}, .prerender = if (@hasDecl(api_viz_spec, "prerender")) api_viz_spec.prerender else false },
