...
| [x] | 5 * | walk . breath | Drafted Paper 3 → `paper/internal-apis-were-not-all-you-needed.tex` (10 §, 11 bibitems): 5 parallel swimmers; doctrine in §8. paper-gate PASS, leak-guard 0, cite↔bibitem closed, every quote verbatim. PDF compile deferred to Overleaf (no local TeX). | `muonry_create` |
