...
identical split mechanism, so ``who deserves the money'' is answered mechanically by who contributed, not by who asks. \prop{} for the staking-reward routing; the
...
split, the claim. The \emph{how} --- the capture, indexing, and platform-integrity
