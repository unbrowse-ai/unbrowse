...
executable tools beating far larger weights on tool-routable tasks: code-correctness
\textbf{25\% $\to$ 100\%} by routing to a real executor; knowledge absent from the
weights \textbf{0\% $\to$ 95\%} by retrieve-then-execute; and \textbf{100\% vs 62\%}
against a 5$\times$-larger model with no tools, on exact tasks. The architecture is the
