 ...
 *
 * Genesis 1:26 — *"dominion."*  John 15:2 — *"purgeth it, that it may bring
 ...
 *       cacheKey. Cross-system Heb 6:18 — two immutable things, same hash.
 ...
 *       the firmament (`canonicalizeSignedFragment` forbidden-field gate).
...
// ───────────────────────────────────────────────────────────────────────────
// E5 — COOKIE CANARY — value never crosses the firmament
// ───────────────────────────────────────────────────────────────────────────
