...
// shouldIndexDomBrowseFallback. Per CLAUDE.md substrate-enables:
...
describe("shouldIndexDomBrowseFallback — admission gate removed (post-2026-05-18 substrate clean-up)", () => {
