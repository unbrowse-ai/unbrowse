...
# Genesis 1:14 — luminaries work for signs AND seasons. Proves the Step 3
...
export function dummy() {
  ...
  // 5 contract steps emitted at call site (3 internal solver states folded into _retry_still_blocked, post-Step-9 sabbath prune).
