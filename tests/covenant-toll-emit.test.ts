/**
 * The "settlement ÷ trace" firmament, settled in code: emitting a toll where a
...
import { DiscoveryLedger } from "../src/covenant-toll-ledger.js";
import { emitTollEvent } from "../src/covenant-toll-emit.js";
