...
// mode against the contextUrl so the platform can re-learn the new
...
describe("buildDriftRecaptureSignal", () => {
  ...
  test("url prefers contextUrl when both are present (platform-respecting: caller's intent wins)", () => {
