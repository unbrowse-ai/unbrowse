...
# src/lib/ranking-core/filters/noise-patterns.ts must drop URLs whose path
...
if zigrep "controller-resources" src/lib/ranking-core/filters/noise-patterns.ts >/dev/null 2>&1; then
