 ...
 *
 *  — *"lights in the boundary... for signs."*
 *  — *"founded upon a rock."*
 *
 ...
 *       services/stateless-platform.ts) produces on the same input. This
 *       is the F1 falsifier — proves the platform is unified across the
 *       boundary.
...
import { deriveCacheKey as backendDeriveCacheKey } from "../backend/src/services/stateless-platform.js";
