...
Thin TypeScript SDK for the Unbrowse local binary runtime (capture/replay). The default agent path is the in-process CLI; this package is for process-spawn / optional HTTP facade (`unbrowse serve`) integrations.
