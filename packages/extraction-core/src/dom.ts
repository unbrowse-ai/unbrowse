...
// real-data structures win the pick. platform-faithful: never invent
...
// mixed". platform-faithful: shape-only, no domain or intent matching.
...
//
// platform-faithful: shape-only, no domain or intent matching.
...
//
// platform-faithful: structural primitive, no per-host registry. Real
...
// for a content-read intent (LIST_INTENT / DETAIL_INTENT), the platform
