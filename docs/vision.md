...
3. **The Unbrowse token: $FDRY.** $FDRY is the Unbrowse token — the native coordination asset of the graph. Stable settlement handles ordinary usage, and $FDRY is the asset for supply-side accountability in higher-trust maintenance, bonding, and dispute resolution. There is exactly one official $FDRY; its on-chain details are published at [FDRY Token Disclosure](reference/fdry.md). See [Accountable Bonding and Where FDRY Fits](concepts/accountable-bonding.md).
