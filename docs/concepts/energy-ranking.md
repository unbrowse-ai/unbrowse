...
The two corroborations are not blended on a fixed recipe. A constant split — "always weigh lexical and structural equally" — wastes the stronger signal on every query that doesn't fit the constant.
