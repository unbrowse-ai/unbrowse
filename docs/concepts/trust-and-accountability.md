...
not mix. (This is the same separation the [contract substrate](./contract-substrate.md#the-economy-rides-the-same-substrate)
...
- **stFDRY** is the *abiding* form of the stake — the staked receipt held by those who
  stay committed through the cooldown rather than trading in and out. The design
  rewards **holding, not spending**: an abiding staker earns a larger maintenance
  ...
  staker can outweigh a nominally-committed whale. The reward is *earn-by-abiding*,
