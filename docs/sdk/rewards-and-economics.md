...
If you are scoping an audit, take the **live** items as production behavior and the **planned** items as forward-looking. The 90/10 split, Flex settlement, and `feedback` ingestion are demonstrably wired today.
