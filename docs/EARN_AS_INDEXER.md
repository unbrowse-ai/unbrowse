...
2. Provision a payout wallet.
   ...
   ```
   Cited in `frontend/src/app/how-unbrowse-pays/page.tsx:226`. Lobster owns the private key. unbrowse only sees the public Solana address you bind to your agent.
