...
Those roadmap pieces are documented in [Coming Soon](../reference/coming-soon.md).

## Choose Your Next Page

* Read [For Technical Readers](../by-audience/for-technical-readers.md) if you want the architecture and eval truth.
* Read [For Investors](../by-audience/for-investors.md) if you want the market and business framing.
* Read [System Today](../reference/system-today.md) if you want the cleanest current-state reference.
