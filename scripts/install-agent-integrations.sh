...
SELF_URL="https://raw.githubusercontent.com/unbrowse-ai/unbrowse/main/scripts/install-agent-integrations.sh"
...
Examples:
  bash <(curl -fsSL https://raw.githubusercontent.com/unbrowse-ai/unbrowse/main/scripts/install-agent-integrations.sh)
  bash <(curl -fsSL https://raw.githubusercontent.com/unbrowse-ai/unbrowse/main/scripts/install-agent-integrations.sh) --all
  bash <(curl -fsSL https://raw.githubusercontent.com/unbrowse-ai/unbrowse/main/scripts/install-agent-integrations.sh) --cursor --codex
EOF
}
